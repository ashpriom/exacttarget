...
get_header('base');
?>
<body <?php body_class(); ?> id="career">

<div id="page" class="hfeed site">
	<?php do_action( 'before' ); ?>
	<header id="masthead" class="site-header career-header" role="banner"  style="background-image:url('<?=wp_get_attachment_url(get_post_thumbnail_id( 451 ))?>')">
	...
	<div class="site-header-wrapper">
		...
		<!--<h1  class="menu-toggle-2"><span class="menu-toggle-icon-2"></span><?php //esc_html_e( 'Menu', 'panel' ); ?></h1>-->
				...
				<?php //wp_nav_menu( array( 'theme_location' => 'career' ) ); ?>
				
			</nav>
			<?php //<hr class="hide-hr"> ?>
	</div>
