...
if(!comments_open(get_queried_object_id() )){
   return; 
}
?>
...
<div id="comments" class="comments-area">
    <?php
    $comments = get_comments(get_queried_object_id());
// You can start editing here -- including this comment! 
    ...
    <?php if (is_array($comments)) : ?>
        <h2 class="comments-title">
            <?php
            echo '<span>' . get_the_title(get_queried_object_id()) . '</span>';
            ?>
        </h2>
        ...
        <ol class="comment-list">
            ...
            wp_list_comments(array('callback' => 'panel_comment', 'avatar_size' => '50'), $comments);
            ?>
        </ol><!-- .comment-list -->
    ...
    <?php comment_form(null, get_queried_object_id()); ?>
