...
<body <?php body_class();?> id="jobposting">

<div id="page" class="hfeed site">
	<?php do_action( 'before' ); ?>
	<header id="masthead" class="site-header jobposting-header" role="banner">
		...
		<div id='id-header' class='all-content-jobposting-header'>
		  <?php 
