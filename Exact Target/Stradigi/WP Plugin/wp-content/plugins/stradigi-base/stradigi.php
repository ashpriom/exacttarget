<?php
/*
Plugin Name: WP Stradigi
Plugin URI: stradigi.ca
Description: The plugin creates dynamic dashoboard menu by queries WordPress database.
Author: Syed Priom
Version: 0.1.1
Author URI: stradigi.ca
Copyright 2017 Stradigi Web Team
License: GPL2
...
// Activation Hook
if (!function_exists('stradigi_install')){
	function stradigi_install(){
		flush_rewrite_rules(); // clear the permalinks
	}
}
register_activation_hook( __FILE__,'stradigi_install');


// Deactivation Hook
if (!function_exists('stradigi_deactivation')){
	function stradigi_deactivation(){
		flush_rewrite_rules();
	}
}
register_deactivation_hook( __FILE__,'stradigi_deactivation');
