...
;
$profileImg = wp_get_attachment_image_src($post_header->bestinshowimage, 'large');
...
<div  class="mainPanel  bestInShow clearfix"   >
    <div class="backgroundLeft" style="background-image:url('<?= $featuredImage[0] ?>')"></div>
    <div class="contentWidth">
        ...
        <div class="display-table ">
            <div class="display-table-cell">
                <div class="inner">
                    <div class="panelBox" >                       
                        <div class=""><img src="<?php echo $profileImg[0] ?>" alt="" class="profile"/></div>                    
                     </div>
                </div>
            </div> 
            <div class="display-table-cell">
