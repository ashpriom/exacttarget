...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header about-header" role="banner" style="background-image:url('<?=wp_get_attachment_url(get_post_thumbnail_id( 579 ))?>')">
