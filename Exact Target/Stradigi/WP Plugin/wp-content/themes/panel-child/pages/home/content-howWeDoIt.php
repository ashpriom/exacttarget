...
$featuredImage = wp_get_attachment_image_src(get_post_thumbnail_id(1258), 'large');
?>

<div  class="mainPanel howWeDoIT "  style="background-image:url('<?= $featuredImage[0] ?>')" >
